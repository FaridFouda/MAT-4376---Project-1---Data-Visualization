...
monthly_avg$samplesize<-NULL
monthly_avg$rawpoll_clinton<-NULL
monthly_avg$rawpoll_trump<-NULL
monthly_avg$rawpoll_johnson<-NULL
monthly_avg$rawpoll_mcmullin<-NULL
monthly_avg
```
...
#Add a per-poll Clinton–Trump spread
